  ...
  return (
    <form onSubmit={saveProduct}>
      ...
      <div className="mb-2 flex flex-wrap gap-1">
          ...
          {!!images?.length &&
            images.map((link) => (
              ...
              >
                ...
                <button
                  onClick={(ev) => removeUpload(ev, link)}
                  className="absolute  bottom-1 right-1 bg-gray-200 rounded-md p-0.5 text-red-800 cursor-pointer "
                >
                  <svg
        ...
        <label
          className="w-24 h-24 cursor-pointer text-center flex flex-col items-center 
        justify-center text-sm gap-1 text-primary rounded-sm bg-white 
